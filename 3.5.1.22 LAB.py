# A method named __str__() is responsible for converting an object's contents into a (more or less) readable string.
class Mouse:
...
# A function named isinstance(Object, Class) checks if an object comes from an indicated class. 
class Mouse:
    pass
